...
class GlobalConfig:
    ...
    DEFAULT_MODEL_INDEX = int(os.environ.get('DEFAULT_MODEL_INDEX', '7'))
    ...
    PPTX_TEMPLATE_FILES = {
        ...
        'RRD Template': {
            'file': _SRC_DIR / 'pptx_templates/RRD_template.pptx',
            'caption': 'RRD theme ⬜'
        },
        'WilliamsLea': {
            'file': _SRC_DIR / 'pptx_templates/WilliamsLea_template.pptx',
            'caption': 'WilliamsLea theme ⬛'
        },
    }
